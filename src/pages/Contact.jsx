      ...
      <div className="container">
        ...
        <div className="row align-items-center mb-4">
          <div className="col-md-7">
            ...
            <p className="lead text-muted">Tell us about your project — we’ll reply with a clear plan, timeline and estimate.</p>
          </div>
        ...
        <div className="row g-4">
              ...
              <form onSubmit={sendByMail} noValidate>
                <div className="row g-3">
                  ...
                  <div className="col-12 d-flex gap-2 align-items-center">
                    ...
                    <small className="text-muted ms-auto">Prefer a call? <a href="tel:+919876543210">+91 98765 43210</a></small>
                  </div>
          ...
          <aside className="col-lg-5">
            <div className="card contact-card p-4 mb-4">
              ...
              <h6>Office hours</h6>
              <p className="text-muted mb-0">Mon — Fri: 10:00 — 18:00 IST</p>
            </div>
            ...
            <div className="card map-card p-0">
              ...
              <div className="map-placeholder d-flex align-items-center justify-content-center">
                <div>
                  ...
                  <p className="mt-2 mb-0 text-muted">Map (replace with Google Maps iframe or embed)</p>
                </div>
              </div>
            </div>
