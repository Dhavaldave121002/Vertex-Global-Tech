...
export default function FloatingActions({
  ...
  return (
    <div className="vg-floating-actions" style={{ bottom: `${bottomOffset}px` }}>
      <a className="vg-float-btn vg-float-whatsapp" href={waHref} target="_blank" rel="noopener noreferrer" aria-label="Chat with us on WhatsApp" title="Chat on WhatsApp">
      ...
      <button className={`vg-float-btn vg-float-top ${visible ? 'visible' : 'hidden'}`} onClick={scrollToTop} aria-label="Scroll to top" title="Back to top">
