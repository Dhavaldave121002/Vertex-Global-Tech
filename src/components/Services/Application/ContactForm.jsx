  ...
  return (
    <form className="row g-2" onSubmit={sendQuote} noValidate>
      ...
      <div className="col-12">
        <textarea name="message" value={form.message} onChange={change} className={`form-control ${errors.message ? 'is-invalid' : ''}`} rows="4" placeholder="Short brief (features, users, timeline)"></textarea>
