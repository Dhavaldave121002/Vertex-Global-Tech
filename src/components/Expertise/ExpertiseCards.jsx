                ...
                <div className="flip-card-inner">
                  <div className="flip-card-face flip-card-front">
                    <div className="icon-wrap" aria-hidden="true">
                      {c.id === 'website' && (<svg width="44" height="44" viewBox="0 0 24 24" aria-hidden="true"><path d="M3 4h18v14H3z" fill="#0d6efd" opacity="0.12"/><path d="M4 6h16v10H4z" fill="#0d6efd"/></svg>)}
                      {c.id === 'application' && (<svg width="44" height="44" viewBox="0 0 24 24" aria-hidden="true"><rect x="4" y="2" width="16" height="20" rx="2" fill="#0dcaf0"/></svg>)}
                      {c.id === 'uiux' && (<svg width="44" height="44" viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="8" r="6" fill="#0d6efd"/></svg>)}
                    </div>
