...
switch($method) {
    case 'GET':
        try {
            // Check/Create Table
            $conn->exec("CREATE TABLE IF NOT EXISTS site_config (
    ...
    case 'PUT':
        ...
        try {
            ...
            $stmt = $conn->prepare("INSERT INTO site_config (config_key, config_value) VALUES (?, ?) ON DUPLICATE KEY UPDATE config_value = ?, updated_at = CURRENT_TIMESTAMP");
